...
<html lang="en">
 ...
 <div class="jumbotron jumbotron-fluid text-center">
      <img src="../img/images/icon/L.PNG" alt="image" height="110" width="110">
    
        <div class="container">
          <h3 class="display-4"><span class="font-weight-bold">BAKSO MATARAM</span></h3>
          <hr>
          <p class="lead font-weight-bold">_Pesan Menu Sesuai Keinginanmu_</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
...
<div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">BAKSO MATARAM</h3>
          <h5>Jl.Kaharuddin Nasution no.210, Pekanbaru
          <br>Buka Jam <strong>10:00 AM - 23:00 PM</strong></h5>
        </div>

        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light shadow">
            <img src="../img/images/background/menu5.jpg" class="card-img shadow" alt="Lihat Daftar Menu">
              <div class="card-img-overlay mt-5 text-center shadow">
               <a href="menu.php" class="btn btn-primary">LIHAT DAFTAR MENU</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light shadow">
            <img src="../img/images/background/menu6.jpg" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center shadow">
               <a href="pesanan_saya.php" class="btn btn-primary">LIHAT PESANAN</a>
              </div>
            </div>
          </div>
        </div>
