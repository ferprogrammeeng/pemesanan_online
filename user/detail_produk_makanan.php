...
<html lang="en">
  ...
  <div class="container">
        ...
        $query = "SELECT * FROM menu_makanan WHERE id_menu_makanan = $product_id";
        $result = $koneksi->query($query);

        if ($result->num_rows > 0) {
            $row = $result->fetch_assoc();
            $nama_menu = $row['makanan']; // Ganti 'nama_menu' dengan 'makanan'
        ?>
            <h1 class="mt-5">Detail Produk Makanan</h1>
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="card">
                        <img src="../img/ayamg.jpg" class="card-img-top" alt="<?php echo $nama_menu; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <form method="POST" action="proses_pembelian_makanan.php">
                                <input type="hidden" name="product_id" value="<?php echo $row['id_menu_makanan']; ?>">
