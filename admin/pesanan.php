...
?>
                ...
                <tbody>
                    ...
                    <?php foreach ($result as $result) : ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $result["waktu_pemesanan"]; ?></td>
                            <td>Rp. <?php echo number_format($result["total_biaya"]); ?>,000</td>
                            <td>

                                <a href="detail_pesanan.php?id=<?php echo $result['id_pesanan'] ?>" class="badge badge-primary">Detail</a>


                                <a href="hapus_pesanan.php?id=<?php echo $result['id_pesanan'] ?>" class="badge badge-danger">Hapus Data</a>
                            </td>
                        </tr>
                        <?php $nomor++; ?>
                    <?php endforeach; ?>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            "dom": '<"top"f>t<"bottom"i<"clear">p>',
            "language": {
                "lengthMenu": "Show _MENU_ entries", // Ubah teks "Show _MENU_ entries" sesuai kebutuhan Anda
            },
        });
    });
</script>
