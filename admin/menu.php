...
$queryMakanan = "SELECT * FROM menu_makanan";
$resultMakanan = $koneksi->query($queryMakanan);

// Query untuk mengambil data menu minuman dari database
$queryMinuman = "SELECT * FROM menu_minuman";
$resultMinuman = $koneksi->query($queryMinuman);
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mr-4" href="pesanan_saya.php">DATA PESANAN</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-md-4 mt-4">
                            <div class="card border-dark shadow">
                                ...
                                <div class="card-body shadow">
                                    ...
                                    <label class="card-text harga"><strong>Rp.</strong> <?php echo $row['harga']; ?></label><br>
                                    <p style="color:red">Sisa Stok : <?php echo $row['sisa_stok']; ?></p>
                                    <a href="detail_produk_minuman.php?id=<?php echo $row['id_menu_minuman']; ?>" class="btn btn-success btn-sm btn-block">BELI</a>
                                </div>
                            </div>
                        </div>
                <?php
