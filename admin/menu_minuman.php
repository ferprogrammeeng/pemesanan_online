...
<body>
    ...
    <strong>Sukses!</strong> Tindakan berhasil dilakukan.
</div>
    ...
    <div class="container">
        <section id="menu-makanan" class="mt-5">
            ...
            <h1>Menu Minuman</h1>
            <a href="tambah_menu_minuman.php" class="btn btn-success mt-3">TAMBAH DAFTAR MENU</a>
            <div class="row">
                <?php
                        ...
                        <div class="col-md-4 mt-4">
                            <div class="card brder-dark shadow">
                                ...
                                <div class="card-body shadow">
                                    <h5 class="card-title font-weight-bold"><?php echo $row['minuman'] ?></h5>
                                    ...
                                    <a href="edit_menu_minuman.php?id_menu=<?php echo $row['id_menu_minuman']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                    <a href="hapus_minuman.php?id_menu=<?php echo $row['id_menu_minuman']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
                                </div>
                            </div>
                        </div>
                <?php
    ...
    <script>
    // Fungsi untuk menampilkan alert dengan pesan tertentu dan menghilangkannya setelah beberapa detik
    function showSuccessAlert(message) {
        const alertDiv = document.getElementById('success-alert');
        alertDiv.innerHTML = '<strong>Sukses!</strong> ' + message;
