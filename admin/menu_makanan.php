...
<body>
    ...
    <div class="container">
        ...
        <a href="tambah_menu_makanan.php" class="btn btn-success mt-3">TAMBAH DAFTAR MENU</a>
        <div class="row">
            <div class="row">
                <?php
                        ...
                        <div class="col-md-4 mt-4">
                            <div class="card brder-dark shadow">
                                ...
                                <div class="card-body shadow">
                                    ...
                                    <a href="edit_menu_makanan.php?id_menu=<?php echo $row['id_menu_makanan']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>
                                    <a href="hapus_makanan.php?id_menu=<?php echo $row['id_menu_makanan']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
                                </div>
                            </div>
                        </div>
                <?php
