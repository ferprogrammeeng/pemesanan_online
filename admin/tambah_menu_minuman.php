        ...
        <div class="card p-5 mb-5">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sisa_stok" name="sisa_stok" placeholder="10"required>
                </div>
                <div class="form-group">
                    <label for="harga">Harga Menu</label>
                    <input type="text" class="form-control" id="harga" name="harga" placeholder="12.000"required>
                </div>
                <div class="form-group">
            ...
            if (isset($_POST['tambah'])) {
                ...
                if (!in_array($file_extension, $allowed_extensions)) {
                    ...
                    $insert = $koneksi->query("INSERT INTO menu_minuman (minuman, sisa_stok, harga, gambar) VALUES ('$nama', '$stok', '$harga', '$nama_file')");
